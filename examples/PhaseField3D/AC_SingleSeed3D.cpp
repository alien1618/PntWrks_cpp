...
{ 
    cout << "-----------------------------------------------------------------" << endl;
    cout << "3D dendritic solidification using the Allen-Cahn phase field model" << endl;
    cout << "-----------------------------------------------------------------" << endl;
	...
	vector<double> U = setVector(pointset.TotalPoints,-1.0);
	vector<double> V0 = setVector(pointset.TotalPoints,0.0);
